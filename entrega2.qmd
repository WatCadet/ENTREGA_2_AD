...
Cruzamos una variable cuantitativa (VHI (columna resultante de la pregunta 1)) con una cualitativa (cafe, tabaco, alcholo, bebidas con gas). Usamos boxplot. El codigo del grafico seria de la siguente manera.
...
ggplot(data, aes(x = cafe, y = VHI)) +
  ...
  labs(x = "Consum de cafe", y = "VHI (calidad)") 
```
