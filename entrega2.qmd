...
```
Se'ls hi demana als individus la freqüència d'alcohol que consumeixen. Poden respondre: "No","Ocasionalment","Setmanalment" i "Diariament". No hi ha una diferència clara a la vista ja que les caixes se solapen. Així que no podem extreure conclusions singificatives del gràfic.

Estudiem si podem aplicar una prova inferencial com l'anova de blocs. 
